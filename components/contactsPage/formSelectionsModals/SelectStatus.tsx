...
type BottomModalSheetProps = {
  ...
  setIsActiveField: (value: boolean) => void;
}

const SelectStatus = (({ ref, isActiveField, setIsActiveField }: BottomModalSheetProps) => {
  ...
  return (
    ...
    >
      <BottomSheetView className="justify-between px-4 pb-12 h-full " >
        ...
        <View>
          <ListOptionCheckBox className="!bg-transparent" isChecked={isActiveField} onPress={() => {
