            ...
            <View className='flex-row gap-4  flex-grow'>
                ...
                <View className='gap-[8px] flex-grow  '>
                    ...
                    <View className='gap-[2px]  '>
                        {sJobTitle && <Text className="text-gray-300 text-sm bg-gray-600 mr-auto py-[2px] rounded-xl px-2  ">{sJobTitle} </Text>}
                        <Text className="text-blue-400 text-sm pl-[3px] ">{sEmail}</Text>
                    </View>
                </View>
            </View>
