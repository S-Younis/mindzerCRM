...
export const CustomerCard = ({ sCustomer, sStatus, sCategory, sContactCount, sOppsCount, ...props }: CustomerCardProps) => {
    return (
        ...
        <Pressable onPress={props.onPress} className={` bg-[#161f2e] border-[#262f3a]  border-[1px]  border-l-8    flex-row gap-4 py-3 px-[14px]  w-[94%] mx-auto  rounded-xl ${props.className} active:opacity-70    `}>
