...
export const CustomInput: React.FC<CustomInputProps> = ({
    ...
    return (
        <View
            className={`flex-row gap-2 bg-slate-100 dark:bg-transparent mb-8 p-2 rounded-lg border  ${isFocused ? 'border-blue-600' : ' border-[#e4e4e4] dark:border-gray-600'}   ${isError && 'border-red-500'}    ${isError && 'dark:border-red-500'} shadow-xs ${containerClassName}`}
        >
            {children ? (
