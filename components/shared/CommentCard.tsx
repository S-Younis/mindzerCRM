...
const CommentCard = ({ sUser, sComment, dateCreated, ...props }: CommentCardProps) => {
  ...
  return (
    <TouchableOpacity {...props} activeOpacity={0.8} className={`flex-row bg-[#161f2e] border border-[#262f3a]  py-5 rounded-lg mb-4 ${props.className} `}>
      ...
      <View className="flex-1 flex gap-[6px] pr-4 ">
        ...
        <View className="flex-row gap-[6px]  justify-between  ">
          <Text className="adaptive-text flex-1 text-sm ">{sComment}</Text>
