    ...
    return (
        <>
            <Stack.Screen
                options={{
                    headerShown: true,
                    header: () => (<View className='flex-row justify-between items-center pt-14 pb-3 px-[16px]'>
                        <Text onPress={() => router.back()} className='text-blue-400 text-lg'>Cancel</Text>
                        <SegmentedControl
